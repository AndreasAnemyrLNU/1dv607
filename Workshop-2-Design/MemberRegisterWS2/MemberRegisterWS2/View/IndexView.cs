...
namespace MemberRegisterWS2.V
{
    ...
    class Index : baseMember
    {
        public IndexMenu SelectedInMenuMain { get; set; }

        public MenuMemberReadAll SelectedInMenuMember { get; set; }

        public MenuMemberDelete selectedInMenuDeleteMember { get; set; }
        ...
        public bool quitTestSelectionAlreadySetByAChildController { get; set; }
        ...
        public void ShowMenuMemberReadQuitOrContinue()
        {
            ...
            Console.WriteLine("# 2 - Read New Member...        ");
            Console.WriteLine("# 3 - Add Boat to this Member   ");
            Console.WriteLine("                                ");
            Console.WriteLine("================================");
            Console.WriteLine("================================");
        }
        ...
        public void RenderingMenuDeleteMemberQuitOrContinueAndRememberClientsSelection()
        {
            ...
            Selected = int.Parse(AskForInput(AskForInt));
            selectedInMenuDeleteMember = (MenuMemberDelete)Selected;
        }
        ...
        public void RenderingMenuMainAndRememberClientsSelection()
        {
            MenuMain();
            Selected = int.Parse(AskForInput(AskForInt));
            SelectedInMenuMain = (IndexMenu)Selected;
        }
